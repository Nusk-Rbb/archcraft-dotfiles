...
complete -c nvme-admin-passthru -s o -l output-format -d 'Set the reporting format to normal, json or binary'
complete -c nvme-admin-passthru -s v -l verbose -d 'Increase the information detail in the output'
complete -c nvme-admin-passthru -s t -l timeout -d 'Override default timeout value.  In milliseconds'
